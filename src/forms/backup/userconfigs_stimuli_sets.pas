{
  Stimulus Control
  Copyright (C) 2007-2017 Carlos Rafael Fernandes Picanço, Universidade Federal do Pará.
...
procedure TFormStimuliSets.FormResize(Sender: TObject);
begin
  ResizeWMHSScroll(rgTrialType);
end;

procedure TFormStimuliSets.KeyGesture(Sender: TObject;
...
procedure TFormStimuliSets.ResizeWMHSScroll(Sender: TObject);
begin
...
procedure TFormStimuliSets.WMHScroll(var Msg: TMessage);
begin
  inherited;
  ResizeWMHSScroll(rgTrialType);
end;
