...
procedure MakeConfigurationFile(ACondition : integer);
{
  ...
  begin
    ...
    begin
      WriteToTrial(i, _Name, 'ClickSoundTrial');
      WriteToTrial(i, _Kind, T_CLS);
      WriteToTrial(i, _ITI, '3000');
      WriteToTrial(i, _cStm, 'A1.PNG');
    end;
  end;
...
begin
  ...
  try
    ...
    case TrialConfig.Kind of
      ...
      T_CLS : Trial := TClickSound.Create(Self);
    end;
